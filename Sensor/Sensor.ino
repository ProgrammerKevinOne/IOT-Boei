...
// network.
static const PROGMEM u1_t NWKSKEY[16] = { 0x47, 0xC7, 0xEF, 0xB5, 0x9C, 0x19, 0x9C, 0x63, 0x05, 0x8E, 0xCC, 0x53, 0x3A, 0x60, 0xD6, 0x61 };

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const u1_t PROGMEM APPSKEY[16] = { 0x89, 0x05, 0x9A, 0x68, 0xAC, 0xB5, 0x49, 0xC9, 0x4A, 0x0F, 0x39, 0xD4, 0xE1, 0x0A, 0xF9, 0x56 };

// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x260B93FF;  // <-- Change this address for every node!
...
int sleepcycles = 110;  //every cycle is 8 sec | 110 for 15 min | 3 for testing
bool sleeping = false;
